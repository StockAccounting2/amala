...
public class FunctionLibrary
{
	public static WebDriver startBrowser(WebDriver driver) throws Exception
	{
		if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("Firefox"))
		{
			...
			{
				System.setProperty("webdriver.chrome.driver", "D:\\NewOJT\\VasuMaven\\ExeFile\\chromedriver.exe");
				driver = new ChromeDriver();
			}else
				if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("IE"))
				{
					System.setProperty("webdriver.ie.driver", "D:\\NewOJT\\VasuMaven\\ExeFile\\IEDriverServer.exe");
	...
	data=driver.findElement(By.id(locatorvalue)).getAttribute("value");	
		...
		FileWriter fw=new FileWriter("D:\\NewOJT\\VasuMaven\\CaptureData\\Data.txt");
	...
	{
		FileReader fr=new FileReader("D:\\NewOJT\\VasuMaven\\CaptureData\\Data.txt");
		...
		{
		String act_data=driver.findElement(By.xpath("//*[@id='ewContentColumn']/div[3]/form/div/div//table[@id='tbl_a_supplierslist']/tbody/tr["+i+"]/td["+column+"]/div/span/span")).getText();
		...
		{
		WebElement stoclitems=driver.findElement(By.xpath("//*[@id='mi_a_stock_items']/a"));
		WebElement stockCategories=driver.findElement(By.xpath("//*[@id='mi_a_stock_categories']/a"));
		Actions mouse=new Actions(driver);
		mouse.moveToElement(stoclitems).build().perform();
		mouse.moveToElement(stockCategories).click().build().perform();
		}
